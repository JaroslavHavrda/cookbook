...
\begin{recipe}{Risotto alla Milanese}
  \ingredient{40g másla} rozpustit
  \ingredient{1 cibule} nakrájet najemno, orestovat
  \ingredient{320 g rýže arborio} přidat, nechat zesklovatět
  \ingredient{1 dl bílého vína} podlít a promíchat
  \ingredient{šafrán} přidat
  \ingredient{vývar} po troškách přidávat, dokud rýže není měkká
  \ingredient{máslo} přidat, nechat rozpustit
  \ingredient{parmazán} nastrouhat, vmíchat do těsta
\end{recipe}
\newpage

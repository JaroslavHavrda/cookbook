...
\begin{recipe}{Bramborová polévka (1 porce)}
  \ingredient{50 g zeleniny}
  \ingredient{70 g brambor } nakrájet na kostičky
  \ingredient{kmín} přidat a povařit
  \ingredient{vývar} přidat
  \ingredient{10 g oleje}
  \ingredient{5 g cibule}
  \ingredient{10 g hladké mouky} udělat světlou jíšku a přidat
  \ingredient{česnek}
  \ingredient{majoránka}
  \ingredient{pažitka}
  \ingredient{sůl} dokořenit polévku
\end{recipe}
\newpage
